...
Object.assign(translations.el, {
  ...
  "Enter your email and we’ll send you a secure recovery link.": "Εισαγάγετε το email σας και θα σας στείλουμε έναν ασφαλή σύνδεσμο ανάκτησης.",
  "Send recovery link": "Αποστολή συνδέσμου ανάκτησης",
  "Remembered it?": "Τον θυμηθήκατε;",
  "Back to sign in": "Επιστροφή στη σύνδεση",
  "Choose a new password": "Επιλέξτε νέο κωδικό πρόσβασης",
  "Create a strong password you haven’t used for this account before.": "Δημιουργήστε έναν ισχυρό κωδικό που δεν έχετε χρησιμοποιήσει ξανά σε αυτόν τον λογαριασμό.",
  "New password": "Νέος κωδικός πρόσβασης",
  "Confirm new password": "Επιβεβαίωση νέου κωδικού",
  "At least 8 characters": "Τουλάχιστον 8 χαρακτήρες",
  "Type it again": "Πληκτρολογήστε τον ξανά",
  "Update password": "Αλλαγή κωδικού",
  "More": "Περισσότερα",
  "Navigation": "Πλοήγηση",
  "Enable notifications": "Ενεργοποίηση ειδοποιήσεων",
  "Notifications on": "Οι ειδοποιήσεις είναι ενεργές",
  "Open deadlines": "Ανοιχτές προθεσμίες",
  "No open deadlines.": "Δεν υπάρχουν ανοιχτές προθεσμίες.",
  "Material link must be a valid http or https URL.": "Ο σύνδεσμος του υλικού πρέπει να είναι έγκυρη διεύθυνση http ή https.",
});
