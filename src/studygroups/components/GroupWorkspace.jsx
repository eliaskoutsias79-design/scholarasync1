  ...
  return (
    <div className="study-group-workspace">
      ...
      <header className="study-group-hero">
        <div>
          <span className="study-group-subject" translate="no">{groupState.group.subject}</span>
          <h2 translate="no">{groupState.group.name}</h2>
          <p translate="no">{groupState.group.description}</p>
        </div>
